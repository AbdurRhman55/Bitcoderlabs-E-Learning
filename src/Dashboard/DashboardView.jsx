...
import { X, Menu, BookOpen, Users, ShoppingBag, BarChart3, TrendingUp, Download, UserPlus } from "lucide-react";
    ...
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <main className={`flex-1 p-4 sm:p-6 ml-20 lg:ml-0 transition-all duration-500`}>
        ...
        <div className="flex items-center justify-between mb-6 sm:hidden">
          ...
          <button className="p-2 rounded-full shadow-md" onClick={() => setOpen(!open)}>
            {open ? <X size={18} /> : <Menu size={18} />}
          </button>
        </div>

        {/* Desktop Title */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 hidden sm:block">{active}</h1>
