...
import { FaBell, FaUserCircle, FaSearch, FaCog, FaSignOutAlt, FaTimes, FaEnvelope, FaGraduationCap, FaCheckCircle, FaExclamationTriangle } from 'react-icons/fa';
...
const DashboardHeader = ({ profile, notifications }) => {
    ...
    const handleDeleteNotification = (id, e) => {
        e.stopPropagation();
        const updatedNotifications = notificationList.filter(notif => notif.id !== id);
        setNotificationList(updatedNotifications);
